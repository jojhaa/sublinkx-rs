...
pub struct UpstreamSubscriptionRecord {
    ...
    pub last_import_updated: i64,
    pub last_import_disabled: i64,
...
impl From<UpstreamSubscriptionRecord> for UpstreamSubscriptionView {
    fn from(value: UpstreamSubscriptionRecord) -> Self {
        Self {
            ...
            sync_enabled: value.sync_enabled != 0,
            ...
            last_import_updated: value.last_import_updated,
            last_import_disabled: value.last_import_disabled,
